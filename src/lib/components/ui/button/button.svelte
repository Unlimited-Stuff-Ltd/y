	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					'bg-red-100 shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 text-white',
				outline:
